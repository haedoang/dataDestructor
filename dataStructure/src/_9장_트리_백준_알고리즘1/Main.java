...
public class Main {
	...
	public static void main(String[] args) {
		...
		int seek = visited.length/2;
		System.out.println(Arrays.toString(numArr));
		//root먼저 방문 
		visited[seek] = true;
		System.out.println(numArr[seek]);
		System.out.println(Arrays.toString(visited));
		
		//4부터 시작하자
		while(!visited[visited.length-1]) {
			
			if(visited[seek/2]==false && seek/2 < visited.length) {
				System.out.printf(numArr[seek/2]); visited[seek/2]=true;			
			} 
			if(visited[seek/2+1]==false && seek/2+1 < visited.length) {
				System.out.printf(numArr[seek/2+1]); visited[seek/2+1]=true;
			}
			seek/=2;
//			
//			else {
...
//			else {
//				System.out.printf(numArr[seek]); visited[seek]=true;
//			}
		}
...
//		while(true) {
//			if(Integer.parseInt(numArr[index*2]) < numArr.length-1) {
//				index*=2;
//			} else {
//				System.out.println(numArr[index]);
//				System.out.println(numArr[index/2]);
//				System.out.println(numArr[index+1]); 
//			}
//		}
//		for(int i=3;i<resultArr.length;i++) {
//			for(int j=1;j<numArr.length;) {
//				if(j*2 < numArr.length && j*2+1 < numArr.length-1) {
//					j*=2;
//				} else {
//					resultArr[i-2]= numArr[j];
//					resultArr[i-1] = numArr[j/2];
//					resultArr[i] = numArr[j+1];
//					j/=2;
//				}
//			}
//		}
...
//			if(i*2 < numArr.length-1 && i*2+1 <numArr.length-1) {
//				i*=2;
//			} else {
////				
////				System.out.printf("numArr["+i+"]:"+numArr[i]);
////				System.out.printf("numArr["+i+"]:"+numArr[i/2]);
...
//			for(int j=1; j*2<numArr.length-1;) {
//				j*=2;
//				result = Integer.parseInt(numArr[j]);
//			}
